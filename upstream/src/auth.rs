...
const GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID: &str = "set-via-env";
const GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET: &str = "set-via-env";
...
const GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_ID: &str = "set-via-env";
const GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET: &str = "set-via-env";
